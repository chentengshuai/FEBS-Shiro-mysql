...
public class ShiroConfig {
    ...
    @Bean
    public DefaultAdvisorAutoProxyCreator defaultAdvisorAutoProxyCreator(DefaultAdvisorAutoProxyCreator defaultAdvisorAutoProxyCreator) {
    ...
    @Bean
    public AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor(AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor) {
        return authorizationAttributeSourceAdvisor;
    }
}
